...
CALORIE_PROMPT = """Проанализируй изображение еды и предоставь ТОЛЬКО числовые данные в формате:
...
Никакого дополнительного текста, описаний или рекомендаций. Только эти 4 строки с числами."""
...
async def handle_photo(message: Message):
    ...
    try:
        ...
        if completion.choices and len(completion.choices) > 0:
            ...
            # Убираем лишнее форматирование из ответа
